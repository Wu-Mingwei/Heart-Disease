...
```{r}
heart%>%
  ggplot(aes(age,chol,color=heart_condition))+geom_point()+geom_smooth(method="lm")+ggtitle("relationship age and chol vs heart_condition in gender")+ facet_wrap(~gender) #plot the point and line for data visualization
```
```{r}
heart%>%
